...
export default function Home() {
  ...
  return (
    <div className="flex items-center justify-center bg-neutral-900 h-full min-h-screen cursor-pointer">
      <div className="flex  flex-col mx-auto justify-center w-[500px] h-[350px] bg-neutral-900 border-neutral-700 border-2">
